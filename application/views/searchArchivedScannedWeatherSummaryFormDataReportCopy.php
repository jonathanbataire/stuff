            ...
            $count = 0;
                ...
                foreach($archivedscannedweathersummaryformreportdataForAMonth as $data){
                    ...
                    <tr>
                        ...
                        <td class="no-print">
                        <a href="<?php echo base_url(); ?>/index.php/SearchArchivedScannedWeatherSummaryFormDataReportCopy/ViewImageFromBrowser/<?php echo $data->FileRef; ?>" target = "blank"><?php echo $data->FileRef; ?></a> 
