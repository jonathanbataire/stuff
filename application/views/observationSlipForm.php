          ...
          function chooseSpeciOrMetar(){
			  ...
			  <div class="tab">
			   <table id="example1" class="table table-bordered table-striped">
                ...
                <select <?php if($userrole=="WeatherForecaster") echo "disabled"; ?> disabled name="metar_speci" id="metar_speci" required class="form-control" onchange="chooseSpeciOrMetar()" >
              ...
              <span class="input-group-addon">SPECI TIME</span>
                ...
                <div class="input-group bootstrap-timepicker timepicker">
                  <input id="timepicker1" type="text" <?php if($userrole=="WeatherForecaster") echo "disabled"; ?> disabled name="speci_time_observationslipform" value="<?php echo $observationslipformidupdate->TIME;?>" id="time_observationslipform" required class="form-control">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                </div>
                <span ng-hide="Timerequired" class="validator">Time required please</span>
              ...
              <script type="text/javascript">
                ...
                <div class="input-group" id="metartimeId"   >
                    ...
                    <select <?php if($userrole=="WeatherForecaster") echo "disabled"; ?> disabled name="metar_time_observationslipform" id="time_observationslipform" required class="form-control">
			  ...
			  <div class = "tab">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tr>
                        ...
                        <select <?php if($userrole=="WeatherForecaster"||$$observationslipformidupdate->Approved=="TRUE"||$userrole=="Observer") echo "disabled"; ?> name="approval" id="approval"  required class="form-control">
                            <option value="<?php echo $observationslipformidupdate->Approved;?>"><?php echo $observationslipformidupdate->Approved;?></option>
                            <option value="TRUE">TRUE</option>
                            
                        </select>
						<input type="hidden" value="<?php echo $name;?>" name="approvedby">
                    </div>
						</td>
					</tr>
                            ...
                            if(is_array($observationslipformdata) && count($observationslipformdata)) {
                              foreach($observationslipformdata as $observationslipdata){
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo $observationslipdata->O_SubmittedBy;?></td>
                                      <th><?php echo $observationslipdata->Remarks;?></th>
                                      <td><?php echo $observationslipdata->Approved; ?></td>
                                      <?php if(  $observationslipformdata[0]->DeviceType!="AWS" && ( $userrole=='OC' || $userrole== "WeatherForecaster" || $userrole=='Observer' || $userrole=="ObserverDataEntrant" || $userrole=='ZonalOfficer' || $userrole=='SeniorZonalOfficer' )){ ?>
                                        <td class="no-print" >
										<?php if($observationslipdata->Approved=='FALSE' && ($observationslipdata->Userid==$session_data['Userid'] || $userrole=='OC' || $userrole== "WeatherForecaster" || $userrole=='ZonalOfficer' || $userrole=='SeniorZonalOfficer' )){ ?>
                                             <table>
											 <tr>
